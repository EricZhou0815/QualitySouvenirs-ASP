...
using QualitySouvenirs.Models.AccountViewModels;
...
namespace QualitySouvenirs.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email,Enabled=true,UName=model.UName,Address=model.Address,MobileNumber=model.MobileNumber };
